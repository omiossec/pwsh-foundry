#
# Module manifest for module 'PwshFoundry'
#
# Generated by: omiossec
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Foundry', 'AI', 'Azure', 'LLM'

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/omiossec/pwsh-foundry/blob/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/omiossec/pwsh-foundry'
